...
export default function AccountPage({ user }: { user: User }) {
  return (
    <div className='mt-10 px-6'>
      ...
      <button
        onClick={logout}
        className='rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary 
                  inline-flex justify-center mx-8 py-2 px-4 border border-gray-300 text-sm font-medium 
